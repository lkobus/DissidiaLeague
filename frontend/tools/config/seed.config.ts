...
export class SeedConfig {
  ...
  */
   ...
   * @type {string}
   */
  //tem que alterar aqui pro instalador, trocar por /franquia/
  APP_BASE = argv['base'] || '/';
  ...
  NPM_DEPENDENCIES: InjectableDependency[] = [
    ...
    //,{ src: '.tmp/ngx-pagination.js', inject: 'libs', buildType: BUILD_TYPES.DEVELOPMENT }
  ];
  ...
  SYSTEM_CONFIG_DEV: any = {
    paths: {
      ...
      'ng2-currency-mask' : 'node_modules/ng2-currency-mask',
      '@ngui/auto-complete': 'node_modules/@ngui/auto-complete/dist/auto-complete.umd.js',
      'angular2-notifications' : 'node_modules/angular2-notification/dist/index.js',
      ...
      '@ngui/map': 'node_modules/@ngui/map/dist',
      echartsLiquidfill: 'node_modules/echarts-liquidfill/dist/echarts-liquidfill.js',
      // For test config
    ...
    map: {
      ...
      'ngx-filesaver': 'node_modules/ngx-filesaver/bundles/ngx-filesaver.umd.js',
      'mydatepicker': 'node_modules/mydatepicker/bundles/mydatepicker.umd.min.js',
      'tslib': 'node_modules/tslib/tslib.js',
      'angular2-notifications': 'node_modules/angular2-notifications',
      'echarts': 'node_modules/echarts',
      'ngx-echarts': 'node_modules/ngx-echarts',
    },
    packages: {
     [this.BOOTSTRAP_DIR]: {
        defaultExtension: 'js'
      ...
      'ngx-echarts': {
        ...
        meta: {
          './*.js': {
            deps: ['echarts','echartsLiquidfill']
          }
        }
      },'angulartics2': {
        main: 'core.umd.js',
  ...
  SYSTEM_BUILDER_CONFIG: any = {
    ...
    paths: {
      ...
      'ngx-echarts': 'node_modules/ngx-echarts/index.js',
